...
if(USE_POPLAR)
  ...
  find_library(EXTERN_LIBRARY_POPNN popnn)
  find_library(EXTERN_LIBRARY_POPLIN poplin)
  ...
  list(APPEND TVM_LINKER_LIBS ${EXTERN_LIBRARY_POPNN})
  list(APPEND TVM_LINKER_LIBS ${EXTERN_LIBRARY_POPLIN})
